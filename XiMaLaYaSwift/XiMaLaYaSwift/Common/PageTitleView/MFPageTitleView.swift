...
class MFPageTitleView: UIView {
    ...
    private lazy var line: UIView = {
        ...
        lineV.backgroundColor = colorWithRGB(244, g: 244, b: 244)
        return lineV
    }()
    //指示器
...
//                    btn.setTitleColor(self.config?.titleColor, for: .selected)
//                    btn.titleLabel?.font = self.config?.titleBigFont
//                }else{
...
//            button.setTitleColor(self.config?.titleColor, for: .selected)
//            button.titleLabel?.font = self.config?.titleBigFont
//        }else{
//            button.setTitleColor(self.config?.titleColor, for: .normal)
